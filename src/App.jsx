...
const optionButtons = [
  ...
  { key: "ro", label: "Dispenser", value: 7, triggerDispense: true },
  { key: "tds", label: "RO + UV", value: 2, triggerDispense: true },
  { key: "tds_ro", label: "RO", value: 4, triggerDispense: true },
  { key: "dispense", label: "Emergency Quick Mode", value: 5 },
  { key: "pump_off", label: "Pump Off", value: 6 },
  { key: "dispenser", label: "Storage", value: 1 }
];
